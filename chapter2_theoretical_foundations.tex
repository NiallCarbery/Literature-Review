...
\end{equation}
%%
\qquad Here, $\sigma_i^z$ denote pauli-z operators on qubit $i$, with $h_i$ representing local field strengths and $J_{ij}$ encoding inter-qubit coupling interactions. The solution landscape of the original optimization problem becomes the ground state configuration of this Hamiltonian in the $Z$-basis measurement.
