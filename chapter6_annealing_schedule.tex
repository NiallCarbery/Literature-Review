% Chapter 6: Modifying the Annealing Schedule
\chapter{Modifying the Annealing Schedule / Comparison to other speedup methods}\label{Ch6:ModifyingSchedule}
...
\begin{equation}\label{eq:local_adiabatic_condition}
...
%%
\begin{equation}\label{eq:gap_squared_scaling}
