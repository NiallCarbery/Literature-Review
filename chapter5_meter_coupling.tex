...
where $H_S(t)$ is the full $N$-qubit system Hamiltonian and $X_M$ is a meter observable. The power of this approach lies in its coupling to the energy eigenspaces of the full system, inducing dephasing precisely in the basis where energy transitions occur. In the largest specific built quantum annealers there is limited connectivity between qubits. Such that the meter couples only to a single or subset target qubit $k$ using a local observable of form;
