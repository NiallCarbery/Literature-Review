...
\titlespacing*{\chapter}{0pt}{-55pt}{25pt}
\titlespacing*{\section}{0pt}{1pt}{2pt}
\titlespacing*{\subsection}{0pt}{1pt}{2pt}
...
\begin{titlepage}
		...
		\begin{center}
			\begin{figure}[th!]
				\centering
		        \includegraphics[width=0.25\linewidth]{figures/ucd.png}
		        % Note: Add UCD logo image file
			\end{figure}
            \begin{Huge}
...
\section{Theoretical Foundations}\label{Ch1:TheoreticalFoundations}
...
\section{Speeding up Quantum Annealing Using Engineered Dephasing}\label{Ch2:SpeedingUpQuantumAnnealing}
...
%----------------------------------------------------------------------
    ...
    \section{Modifying the Annealing Schedule}\label{Ch3:ModifyingSchedule}
...
%----------------------------------------------------------------------
    ...
    \section{Modifying the meter coupling}\label{Ch3:ModifyingConnection}

    \subsection{Meter to Single Qubit Coupling}
...
%----------------------------------------------------------------------
    ...
    \section{Modifying the interaction terms}\label{Ch4:ModifyingInteraction}
...
\begin{refsection}
    ...
    \newpage
    \section{Appendix: Coherence Diagnostic for Single-Qubit Meter Coupling}\label{App:CoherenceDiagnostic}
    ...
    \newpage
    \section{Appendix: Additional Papers and Reproduced Results}
    ...
    \begin{figure}[H]
        ...
        \end{subfigure}
        \caption{Optimization of annealing protocol for the two-spin Hamiltoninan. (a) fidelity of the final state as a function of total annealing time $T$ for three cases: bare annealing (no LCD), first-order LCD, and combined first-and second-order LCD. }
        \label{fig:COLD_fig1}
    \end{figure}
