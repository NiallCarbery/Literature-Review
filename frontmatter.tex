...
\section*{Acronyms and Abbreviations}
    ...
    \textbf{QUBO}\label{acr:QUBO} & Quadratic Unconstrained Binary Optimization \\[7pt]
    \end{tabular}
\end{table}
